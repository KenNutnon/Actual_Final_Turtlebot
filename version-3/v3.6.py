...
#add delay
for u in range(20):
  control_linear.append(0)
  control_Angular.append(0)
...
class Follower:
  ...
  def image_callback(self, msg):
    ...
    if mid_white:
    ...
    elif self.that_white_line() and fol_w == False:
      ...
      if self.Mw['m00'] > 0 and self.My['m00'] > 0:
        ...
        control_linear.append(speed)
        control_Angular.append((-float(err) / 100)*3)

        self.twist.linear.x = control_linear[self.count]
        self.twist.angular.z = control_Angular[self.count]
        ...
        self.twist.linear.x = control_linear[self.count]
        self.twist.angular.z = control_Angular[nself.count]
